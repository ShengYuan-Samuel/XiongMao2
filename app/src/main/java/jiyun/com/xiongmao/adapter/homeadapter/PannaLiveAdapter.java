...
import jiyun.com.xiongmao.beans.homebeans.ListBean;

public class PannaLiveAdapter extends RecyclerView.Adapter<PannaLiveAdapter.ViewHolder>{
    private List<ListBean> mList;
    private Context context;

    public PannaLiveAdapter(List<ListBean> mList, Context context) {
        this.mList = mList;
    ...
    @Override
    public void onBindViewHolder(@NonNull PannaLiveAdapter.ViewHolder holder, int position) {
